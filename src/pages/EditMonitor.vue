                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="my-3">
                                ...
                                <input id="interval" v-model="monitor.interval" type="number" class="form-control" required min="3" step="1">
                            </div>
                            ...
                            <div class="my-3">
                                ...
                                <input id="retry-interval" v-model="monitor.retryInterval" type="number" class="form-control" required min="3" step="1">
                            </div>
